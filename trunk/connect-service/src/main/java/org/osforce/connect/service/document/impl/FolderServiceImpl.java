...
public class FolderServiceImpl implements FolderService {
	...
	public List<Folder> getFolderList(Long projectId) {
		return folderDao.findFolderList(projectId, null);
	}
	
	public List<Folder> getFolderList(Long projectId, Long parentId) {
		return folderDao.findFolderList(projectId, parentId);
	}
}
