...
public class MessageServiceImpl implements MessageService {
	...
	public Page<Message> getMessagePage(Page<Message> page, Project project, String box) {
		return messageDao.findMessagePage(page, project.getId(), box);
	}

	public Long countMessages(Project project, Boolean read) {
		return messageDao.countMessages(project.getId(), read);
	}
