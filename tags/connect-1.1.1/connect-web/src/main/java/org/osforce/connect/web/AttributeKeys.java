...
public  abstract  class AttributeKeys {
	...
	public static final String PROJECT_UNIQUE_KEY_READABLE = "uniqueId";
	...
	public static final String BLOG_POST_KEY  =  "_" + Post.class.getName();
	...
	public static final String BLOG_CATEGORY_KEY = "_" + PostCategory.class.getName();
